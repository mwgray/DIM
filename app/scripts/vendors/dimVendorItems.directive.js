(function() {
  ...
  var VendorItem = {
    ...
    template: [
      ...
      '  <div class="cost" ng-if="$ctrl.cost" ng-class="{notenough: ($ctrl.totalCoins[$ctrl.cost.currency.itemHash] < $ctrl.cost.cost)}">',
      '    {{::$ctrl.cost.cost}}',
  ...
  var VendorItems = {
    ...
    template: [
      ...
      '       <div ng-if="store.vendors[vendorHash].items.shaders.length">',
      '         <h3 ng-if="true">Shaders</h3>',
      '         <div class="vendor-armor">',
      '           <dim-vendor-item ng-repeat="saleItem in store.vendors[vendorHash].items.shaders" sale-item="saleItem" cost="store.vendors[vendorHash].costs[saleItem.hash]" total-coins="vm.totalCoins" item-clicked="vm.itemClicked(saleItem, $event)"></dim-vendor-item>',
      '         </div>',
      '       </div>',

      '       <div ng-if="store.vendors[vendorHash].items.emblems.length">',
      '         <h3 ng-if="true">Emblems</h3>',
      '         <div class="vendor-armor">',
      '           <dim-vendor-item ng-repeat="saleItem in store.vendors[vendorHash].items.emblems" sale-item="saleItem" cost="store.vendors[vendorHash].costs[saleItem.hash]" total-coins="vm.totalCoins" item-clicked="vm.itemClicked(saleItem, $event)"></dim-vendor-item>',
      '         </div>',
      '       </div>',

      '       <div ng-if="store.vendors[vendorHash].items.ships.length">',
      '         <h3 ng-if="true">Ships</h3>',
      '         <div class="vendor-armor">',
      '           <dim-vendor-item ng-repeat="saleItem in store.vendors[vendorHash].items.ships" sale-item="saleItem" cost="store.vendors[vendorHash].costs[saleItem.hash]" total-coins="vm.totalCoins" item-clicked="vm.itemClicked(saleItem, $event)"></dim-vendor-item>',
      '         </div>',
      '       </div>',

      '       <div ng-if="store.vendors[vendorHash].items.vehicles.length">',
      '         <h3 ng-if="true">Vehicles</h3>',
      '         <div class="vendor-armor">',
      '           <dim-vendor-item ng-repeat="saleItem in store.vendors[vendorHash].items.vehicles" sale-item="saleItem" cost="store.vendors[vendorHash].costs[saleItem.hash]" total-coins="vm.totalCoins" item-clicked="vm.itemClicked(saleItem, $event)"></dim-vendor-item>',
      '         </div>',
      '       </div>',
